...
public class Translations {
    public static boolean HandleSpecialPidEnumerations(Context context, PID pid, ArrayList<Short> buffer) {
    ...
    private static void mode1Pid01_Translation(Context context, PID pid, ArrayList<Short> buffer) {
